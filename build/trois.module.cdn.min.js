...
`;var sr=_("ShaderMaterial",{props:{type:Object,default:()=>({uniforms:{},vertexShader:Oi,fragmentShader:$i})}},e=>new ve(Q(e,["color"])));function zi(e,t,r){return e.split(t).join(r)}const Ei=V.meshphong_frag.slice(0,V.meshphong_frag.indexOf("void main() {")),Ri=V.meshphong_frag.slice(V.meshphong_frag.indexOf("void main() {")),ji={uniforms:Re.merge([Xs.phong.uniforms,{thicknessColor:{value:new Y(16777215)},thicknessDistortion:{value:.1},thicknessAmbient:{value:0},thicknessAttenuation:{value:.1},thicknessPower:{value:2},thicknessScale:{value:10}}]),vertexShader:`
    #define USE_UV
    ${V.meshphong_vert}
  `,fragmentShader:`
    #define USE_UV
